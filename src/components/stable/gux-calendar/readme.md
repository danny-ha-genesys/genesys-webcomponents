...
| `mode`           | `mode`             | The calendar mode (can be single or range) | `CalendarModes.Month \| CalendarModes.Range \| CalendarModes.Single \| CalendarModes.Week` | `CalendarModes.Single` |
